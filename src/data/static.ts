export const servicesData = [
    {
        ...
        description: "Seamlessly migrate your existing website to WordPress from any CMS (Wix, Squarespace, Webflow, Shopify, or Custom HTML). I ensure zero data loss, perfect SEO preservation, and a smooth transition to a more powerful platform.",
        features: ["SEO Preservation", "Zero Data Loss", "Content Mapping", "URL Redirection"],
        icon: "fas fa-server",
        link: "/contact"
    },
    {
        title: "Full Stack Development",
        description: "End-to-end software development crafting robust backends and interactive frontends. I build scalable architectures tailored to specific business requirements, ensuring high performance, security, and exceptional user experiences.",
        features: ["RESTful API Design", "Database Modeling", "Cloud Deployment", "SPA Architecture"],
        icon: "fas fa-laptop-code",
        link: "/contact"
    },
    {
        title: "WordPress Development",
        description: "Designing sophisticated, high-conversion websites utilizing the complete power of WordPress. From custom theme creation and plugin integration to seamless e-commerce setups with WooCommerce.",
        features: ["Custom Theme Design", "Divi / Elementor", "Speed Optimization", "WooCommerce Setup"],
        icon: "fas fa-paint-roller",
        link: "/contact"
    },
    {
        title: "AI & ML Integrations",
        description: "Empowering businesses by integrating smart functionality. Whether it's setting up predictive models, natural language processing tools, or automated intelligent processes to reduce overhead.",
        features: ["Model Deployment", "Data Processing APIs", "Text Classification", "Python & TensorFlow"],
        icon: "fas fa-network-wired",
        link: "/contact"
    },
    {
        title: "UI/UX Design",
        description: "Going beyond code, I craft user interfaces that captivate and engage. Prototyping intuitive user flows and building design systems that perfectly balance visual aesthetic with accessibility.",
...
export const faqsData = [
    {
        ...
        answer: "Turnaround time varies based on the scope and complexity of the project. A standard multi-page website usually takes around 2-3 weeks, while more complex web applications with AI integrations can take 1-2 months."
    },
    {
        question: "Do you provide ongoing support and maintenance?",
        answer: "Yes! I offer dedicated maintenance packages to ensure your website remains secure, fast, and up-to-date with the latest features and plugin updates, particularly for WordPress platforms."
    },
    {
        question: "What is your design process?",
        answer: "Everything starts with a discovery call to understand your goals. From there, I create wireframes and UI mockups. Once approved, I move into semantic, responsive HTML/CSS/JS development and integrate necessary backends or CMS solutions."
    }
];
...
export const featuredBlogPost = {
    title: "The Future of Frontend: Micro-Frontends & Module Federation Explained",
    category: "Web Development",
    date: "Apr 12, 2026",
    readTime: "8 min read",
    excerpt: "As applications grow in complexity, managing monstrous monoliths becomes a nightmare. Micro-frontends offer a solution by breaking down the UI into smaller, independently deployable pieces. Learn how Module Federation in Webpack 5 is changing the game.",
...
export const blogPosts = [
    {
        ...
        date: "Mar 28, 2026",
        excerpt: "Discover practical patterns for weaving Large Language Models into your existing software products, from smart search functionalities to completely automated user workflows.",
    ...
    },
    {
        ...
        date: "Mar 15, 2026",
        excerpt: "A comprehensive guide on variables, auto-layout, and component properties to create robust design systems that bridge the gap between designers and developers.",
    ...
    },
    {
        ...
        category: "Web Development",
        date: "Feb 10, 2026",
        excerpt: "Stop guessing why your React app is slow. Use the Profiler API to pinpoint unnecessary re-renders and implement memoization correctly.",
    ...
    },
    {
        ...
        category: "Artificial Intelligence",
        date: "Jan 29, 2026",
        excerpt: "A collection of handy Python automation scripts to handle repetitive tasks, data cleaning, and API testing in your day-to-day workflow.",
    ...
    },
    {
        ...
        category: "UI/UX Design",
        date: "Jan 14, 2026",
        excerpt: "How to use Cognitive Load theory, Hick's Law, and the Von Restorff effect to design interfaces that users naturally understand and enjoy using.",
