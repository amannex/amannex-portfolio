    ...
    <section className="section section-alt">
        ...
        <div className={`${styles['services-grid']}`}>
                {servicesData.map((service, index) => (
                    <div key={index} className={`${styles['service-card']} ${forcedState[index] === 'open' ? styles['force-open'] : ''} ${forcedState[index] ? 'fade-up visible' : 'fade-up'}`} onMouseEnter={() => handleMouseEnter(index)} onClick={() => handleCardClick(index)}>
                                    ...
                                    <div className={`${styles['service-body-inner']}`}>
                                        ...
                                        <div className={`${styles['service-features']}`}>
                                            {service.features.map((feature, idx) => (
                                                <div key={idx} className={`${styles['service-feature']}`}><i className="fas fa-check"></i> {feature}</div>
                                            ))}
                                        </div>
                                        
                                        <div><Link to={service.link} className="btn btn-outline interactive-element">Start a Project <i className="fas fa-arrow-right"></i></Link></div>
                                    </div>
                                </div>
                            </div>
